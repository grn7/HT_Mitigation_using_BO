...
import matplotlib
matplotlib.use('Agg')  # This prevents GUI window from opening
...
def plot_convergence_comparison(bo_costs_raw, ga_costs_raw, sa_costs_raw, window_size=5, save_path="convergence_comparison.png"):
    """
    Plot convergence comparison for all three algorithms and save to file
    ...
    print(f"Convergence plot saved as: {save_path}")
    plt.close()
...
def plot_grid_with_path(grid_obj, path, k, title, color='blue', linestyle='-', 
                        marker_color='cyan', save_filename="grid_plot.png"):
    """
    Plot EHWP grid with overlaid path and save to file
    ...
    print(f"Grid plot saved as: {save_filename}")
    plt.close()
...
if __name__ == "__main__":
    ...
    # 1. Convergence comparison plot (all algorithms) - SAVED AS PNG
    bo_costs_np, ga_costs_np, sa_costs_np = plot_convergence_comparison(
        train_Y, ga_all_costs, sa_all_costs, window_size=5, 
        save_path="FINALYYYYYYYYYYYYYYYY.png"  # Saves the convergence plot with your requested name
    )
    ...
    plot_grid_with_path(
        EHWP, bo_best_path, k, 
        title="BO", color='blue', linestyle='-', 
        marker_color='cyan', save_filename="BO_optimization_result.png"
    )
    ...
    plot_grid_with_path(
        EHWP, ga_best_path, k, 
        title="GA", color='red', linestyle='--', 
        marker_color='red', save_filename="GA_optimization_result.png"
    )
    ...
    plot_grid_with_path(
        EHWP, sa_best_path, k, 
        title="SA", color='yellow', linestyle=':', 
        marker_color='yellow', save_filename="SA_optimization_result.png"
    )
    ...
    plot_grid_with_path(
        EHWP, rl_best_path, k,
        title="RL", color='magenta', linestyle='-.',
        marker_color='magenta', save_filename="RL_optimization_result.png"
    )
    ...
    print("\nAll plots have been saved to the following files:")
    print("  - FINALYYYYYYYYYYYYYYYY.png (convergence comparison)")
    print("  - BO_optimization_result.png")
    print("  - GA_optimization_result.png")
    print("  - SA_optimization_result.png")
    print("  - RL_optimization_result.png")
    print("\nYou can view these files using any image viewer or transfer them via SCP.")